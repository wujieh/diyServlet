...
public class WebApp {
    ...
    static {
        ...
        try {
            ...
            File f = new File("D:\\diyServlet\\src\\main\\resources\\web.xml");
            if (f.exists()) {
                System.out.println("web.xml存在");
            } else {
            ...
            FileInputStream is = new FileInputStream("D:\\diyServlet\\src\\main\\resources\\web.xml");
    ...
    public static Service getServlet(String action) {
        ...
        Service servlet = null;
        if (classPath != null) {
            Class<?> clazz = null;
            try {
                clazz = Class.forName(classPath);
                servlet = (Service) clazz.newInstance();//要确保空构造存在
